			...
			array(
				'fragments' => apply_filters(
					'woocommerce_update_order_review_fragments', array(
						'form.woocommerce-checkout' => '<div class="woocommerce-error">' . __( 'Sorry, your session has expired.', 'woocommerce' ) . ' Click <a href="' . site_url('products') . '" class="wc-backward">' . __( 'here', 'woocommerce' ) . '</a>  to view more products.</div>',
					)
				),
			)
		);
