	...
	public function process_checkout() {
		try {
			...
			if ( WC()->cart->is_empty() ) {
				...
				throw new Exception( sprintf( __( 'Sorry, your session has expired.  Click <a href="%s" class="wc-backward">here</a> to view more products.', 'woocommerce' ), site_url('products')) );
			}
